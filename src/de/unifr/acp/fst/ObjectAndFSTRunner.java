...
/**
 * An immutable object and FST runner pair. Uses the object's identity
 * in for its <code>equals</code> and <code>hashCode</code> semantics.
 * 
 * @author geffken
 */
public final class ObjectAndFSTRunner {
    public final Object obj;
    public final FSTRunner runner;

    public ObjectAndFSTRunner(Object obj, FSTRunner runner) {
        this.obj = obj;
        this.runner = runner;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ObjectAndFSTRunner other = (ObjectAndFSTRunner) obj;
        if (this.obj == null) {
            if (other.obj != null)
                return false;
